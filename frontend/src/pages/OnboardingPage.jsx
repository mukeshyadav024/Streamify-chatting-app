...
const OnboardingPage = () => {
  ...
  return (
    <div className="h-screen bg-base-100 flex items-center justify-center px-2 py-4 sm:px-4">
      <div className="card bg-base-200 w-full max-w-3xl shadow-xl h-full sm:h-auto">
        <div className="card-body p-4 sm:p-6 flex flex-col overflow-y-auto">
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-3">
              <div className="size-20 sm:size-24 rounded-full bg-base-300 overflow-hidden">
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                className="textarea textarea-bordered h-16 textarea-sm"
                value={formState.bio}
                onChange={(e) =>
